function Comet_Trajectory(filename)
    ...
    Trajectory(LSWI(x,G,s,0), LSWI(y,G,s,0),filename,...
        {'Color', [0 .76 1], 'LineWidth',1.5});
    Trajectory(LSWI(x,G,s,2.0),LSWI(y,G,s,2.0),filename,...
    ...
    title(['Assignment 1: Inverting for the Trajectory of a Comet in ', filename]);
